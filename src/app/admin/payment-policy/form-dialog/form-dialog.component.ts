...
export class FormDialogComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    if (this.action === 'EDIT' ) {
      ...
      this.http.get<PaymentPolicy>(`https://hostapp-8mxk.onrender.com/payment-policy/get/${id}`).subscribe(policy => {
        this.leads = policy;
        this.populateForm();
      });
    } else {
  ...
  confirmAdd(): void {
    if (this.PolicyForm.valid) {
      ...
      if (this.action === 'ADD') {
        this.http.post<PaymentPolicy>('https://hostapp-8mxk.onrender.com/payment-policy', paymentPolicy)
          .subscribe(
        ...
        this.http.put<PaymentPolicy>(`https://hostapp-8mxk.onrender.com/payment-policy/put/${policyId}`, paymentPolicy)
          .subscribe(
